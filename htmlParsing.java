...
public class htmlParsing {
	 ...
	 * links out of a given url. Only the the www.cs.mcgill.ca domain is considered.
	 * Personnal web pages (those with URL containing "~") are not considered. Only
	 * html links are considered. The given url must contain the full path (implicit
	 * "index.html" are not allowed). So "http://www.cs.mcgill.ca" is not a valid
	 * URL, but "http://www.cs.mcgill.ca/index.html" is.
	 */
	...
	static public LinkedList<String> getLinks(String url) throws Exception {
		...
		if (queriedURL_links.containsKey(url))
			throw new Exception("Tried to query the following URL twice: " + url);
	...
	/*
	 * Returns a LinkedList of Strings corresponding containing all the words at a
	 * given url. Only the the www.cs.mcgill.ca domain is considered. Personnal web
	 * pages (those with URL containing "~") are not considered. Only html links are
	 * considered. The given url must contain the full path (implicit "index.html"
	 * are not allowed). So "http://www.cs.mcgill.ca" is not a valid URL, but
	 * "http://www.cs.mcgill.ca/index.html" is. Words inside html tags are not
	 * considered.
	 */
	...
	static public String fixURL(String url) {
		...
		if (i == -1)
			i = url.indexOf("%7E");
		if (i != -1)
			url = url.substring(0, i) + "~" + url.substring(i + 3, url.length());
	...
	static public LinkedList<String> parseLine(String line, String domain) {
		...
		if ((domain.indexOf(u) != -1 || u.indexOf("javascript") != -1 || u.indexOf("https") != -1
				|| u.indexOf("Members") != -1 || u.indexOf(".doc") != -1 || u.indexOf("reservations") != -1
				|| u.indexOf("announcements") != -1 || u.indexOf("registration") != -1 || u.indexOf("login_form") != -1
				|| u.indexOf("mailto") != -1 || u.indexOf("#") != -1 || u.indexOf("jette") != -1 || u.indexOf("bias") != -1
				|| u.indexOf(".cgi") != -1 || u.indexOf(".mp3") != -1 || u.indexOf(".ppt") != -1 || u.indexOf(".pl") != -1
				|| u.indexOf(".jpg") != -1 || u.indexOf(".dmg") != -1 || u.indexOf(".mso") != -1 || u.indexOf(".xml") != -1
				|| u.indexOf(".css") != -1 || u.indexOf("internal") != -1 || u.indexOf(".java") != -1 || u.indexOf(".png") != -1
				|| u.indexOf("<li>") != -1 || u.indexOf(".exe") != -1 || u.indexOf(".aft") != -1 || u.indexOf(".pdf") != -1
				|| u.indexOf(".ico") != -1 || u.indexOf(".ps") != -1 || u.indexOf("?") != -1 || u.indexOf("credits") != -1
				|| u.indexOf("..") != -1 || u.indexOf("./") != -1 || u.indexOf("@") != -1 || u.indexOf("tar") != -1
				|| u.indexOf("gz") != -1 || u.indexOf("zip") != -1 || u.indexOf("txt") != -1 || u.indexOf("hqx") != -1
				|| u.indexOf("mws") != -1 || u.indexOf("finak") != -1 || u.indexOf("nex") != -1))
			return ret;
